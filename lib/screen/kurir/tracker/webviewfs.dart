...
import 'package:idaman/models/kategori_lokasi.dart';
...
import '../../../components/shortcut_icon_h.dart';
import '../../../constants.dart';
import '../../../helper/webjscoll.dart';
import '../../../main.dart';
import '../../../models/Location.dart';
import '../../../models/UmkmData.dart';
import '../../../size_config.dart';
import '../../penjual/usaha/usaha_screen.dart';
      ...
      ..setNavigationDelegate(
        NavigationDelegate(
          ...
          onPageFinished: (String url) {
            ...
            myLocation();
            _webViewController.runJavaScript("getTerdekat('"+ endPoint +"get_usaha?id=1&user_lon="+ lon +"&user_lat="+lat+"&radius=50&batas=25');");
            // _webViewController.runJavaScriptReturningResult("coba();");
          },
...
Page resource error:
      ...
      ..addJavaScriptChannel(
        ...
        onMessageReceived: (JavaScriptMessage message) async{
          ...
          if(message.message == "getmylocation"){
            ...
            //
            // print(ls.getCurrentPosition().toString());
          }
          ...
          if(message.message == "getSiapkk"){
            String jscall = autoLoginJS();
            if(jscall!="false") {
          ...
          if(message.message == "getterdekat"){
            _webViewController.runJavaScript("getTerdekat('"+ endPoint +"get_usaha?id=1&user_lon="+ lon +"&user_lat="+lat+"&radius=50&batas=25');");
          }
        ...
        body: Scaffold(
          drawer: Drawer(
            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                children: [
                  ...List.generate(dk.length, (index) =>
                      ShortcutIconH(
                        imgSrc: dk[index].icon.toString(),
                        text: dk[index].nama.toString(),
                        press: () {
                          Navigator.pop(context);
                          _webViewController.runJavaScript("getPlaces('"+ dk[index].nama.toString() + "');");
                        },
                        koman: '',
                        anak: dk[index].anak!,
                      )
  ...
  myLocation() async{
    LocationModel position = new LocationModel(latitude: "", longitude: "", isMock: true);
    LocationService lc = new LocationService();
    position = await lc.getCurrentPosition();
  ...
  void loadKategoriLokasi() async{
    APIService api = new APIService();
    KategoriLokasiModel klm = await api.getKategoriLokasi();
    dk = klm.data!;
    setState(() {

    });
    //dk = klm.dataKategori.toList();
    print("panjang datta : " + dk.length.toString());
  }
}
